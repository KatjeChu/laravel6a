                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="single-features-ads first">
                            ...
                            <h4>Free shipping</h4>
                            <p>Регистрация и роли пользователей <br />(admin + user) 
                    ...
                    <div class="col-lg-4">
                        <div class="single-features-ads second">
                            ...
                            <p>Поиск товаров, pagination по товарам, просмотр выбранного товара, корзина товаров который добавил пользователь, оформление заказа</p>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="single-features-ads">
                            ...
                            <p>Со стороны администратора сделать добавление и редактирование товаров
                                <br />
                                А также есть удаление х_Х
                            </p>
                        </div>
                    </div>
                </div>
